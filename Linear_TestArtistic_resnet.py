...
parser.add_argument("--matrixPath", default='trainingOutput_pretrained_resnet_softmax2/r41_resnet_softmax_imagenet2.pth',
                    help='pre-trained model path')
parser.add_argument("--stylePath", default="data/style/",
                    help='path to style image')
parser.add_argument("--contentPath", default="data/content/",
                    help='path to frames')
parser.add_argument("--outf", default="Artistic_pretrained_resnet_softmax2/",
