...
parser.add_argument("--outf", default="trainingOutput_pretrained_resnet_softmax/",
...
for iteration in range(1,opt.niter+1):
    ...
    if(iteration > 0 and (iteration) % opt.save_interval == 0):
        torch.save(matrix.state_dict(), '%s/%s_resnet_softmax_imagenet.pth' % (opt.outf,opt.layer))
