...
# load model
PRETRAIN = 'imagenet'  # 'imagenet', 'none'
TARGET_SOURCE = 'content'  # 'random', 'content'
OPTIMIZOR = 'LBFGS'  # 'Adam', 'LBFGS'
ARCHITECTURE = 'wide_resnet50_2_softmax_v2'
...
def get_features(image, model, temperature, layers=None):
    ...
    elif ARCHITECTURE == 'resnet50_small_conv' or ARCHITECTURE == 'resnet50_plain2' or ARCHITECTURE == 'resnet50_plain3' or ARCHITECTURE == 'resnet50_plain6' or ARCHITECTURE == 'resnet50_plain9' or ARCHITECTURE == 'resnet50_plain10' or ARCHITECTURE == 'resnet50_plain17' or ARCHITECTURE == 'resnet50_plain18' or ARCHITECTURE == 'resnet50_plain20' or ARCHITECTURE == 'resnet50_plain21':
    ...
    elif ARCHITECTURE == 'resnet50_plain16' or ARCHITECTURE == 'resnet50_plain12' or ARCHITECTURE == 'resnet50_plain23':
        if layers is None:
            layers1 = {'0': 'conv1_0',
                       '1': 'conv1_1',
                       '2': 'conv1_2'
    ...
    elif ARCHITECTURE == 'resnet50_plain24' or ARCHITECTURE == 'resnet50_plain25':
        if layers is None:
            layers1 = {'0': 'conv1_0'
                       }
            layers2 = {'0': 'conv2_0',
    ...
    elif ARCHITECTURE == 'wide_resnet50_2_softmax':
        if layers is None:
            layers1 = {'0': 'conv1_0',
                       '1': 'conv1_1',
                       '2': 'conv1_2'
    ...
    elif ARCHITECTURE == 'wide_resnet50_2_softmax_v2':
        if layers is None:
            layers1 = {'0': 'conv1_0',
                       '1': 'conv1_1',
                       '2': 'conv1_2'
...
if PRETRAIN == 'imagenet':
    resnet = models.__dict__['wide_resnet50_2'](pretrained=True)
else:
    resnet = models.__dict__['wide_resnet50_2'](pretrained=False)
...
for i_style in range(len(style_image_list)):
    for i_content in range(len(content_image_list)):
        ...
        final_styled, style_loss = style_transfer(resnet, style, content, target, style_weights, content_weights,
